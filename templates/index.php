<section class="promo">
    ...
    <ul class="promo__list">
        <?php foreach ($categories as $category): ?>
            <li class="promo__item promo__item--<?=$category['category_en'];?>">
                ...
                <div class="lot__info">
                    ...
                    <div class="lot__state">
                        <div class="lot__rate">
                            ...
                            <span class="lot__cost"><?=prices($lot['price']);?></span>
                        </div>
                        <div class="lot__timer timer <?php if (get_enough_time($lot['end_date'])): ?>timer--finishing<?php endif; ?>">
